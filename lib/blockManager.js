...
function calculatePPSPayments(blockHeader, callback) {
    if (global.config.coin.networkFee) {blockHeader.reward = blockHeader.reward - (blockHeader.reward * global.config.coin.networkFee)}; 
...
function calculatePPLNSPayments(block_height, block_reward, block_difficulty, unlock_callback) {
    if (global.config.coin.networkFee) {block_reward = block_reward - (block_reward * global.config.coin.networkFee)}; 
