...
function full_stop(err) {
    ...
    global.support.sendtoTelegram(global.config.admin_telegram, "Payment daemon unable to make payment TUBE");
}
            ...
            global.support.sendEmail(rows[0].email,
                ...
                sprintf(
                    ...
                    (payee.tx_hash && payee.tx_key ?
                        ...
                        "Here is link to verify that this payment was made: https://explorer.bit.tube/prove/%(tx_hash)s/%(address)s/%(tx_key)s\n" +
