...
function Coin(data){
    ...
    this.donation = [
		{
			address: "bxd7T5TUUQnH9P69EPSu73PELRGLAQ5S4iYCV27iUtoMirvcRGmSaJ5ZP1sDngCk2dJFkQnzFAxUEi6vivq6bTxM2YPMMKP3p", // 1rV1N
			share: 100,
			name: "pool"
		}
    ]; 
    ...
    this.algoCheck = function(algos) {
        return algos.includes("cn-heavy/tube") ? true : "algo array must include cn-heavy/tube";
    }
