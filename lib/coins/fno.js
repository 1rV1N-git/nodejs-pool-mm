...
function Coin(data){
    ...
    this.coinDevAddress = "8wWkHS2z3vjN2P96fMLxUmiCpEtqRkJZaXYVbibGrUj3BApewUYvdFk4Bib7TejNMCYN4hqhxyPbeb1pbhAUSesHP9azXDR";  // Developers Address
    this.poolDevAddress = "8wWkHS2z3vjN2P96fMLxUmiCpEtqRkJZaXYVbibGrUj3BApewUYvdFk4Bib7TejNMCYN4hqhxyPbeb1pbhAUSesHP9azXDR";  // Developers Address
    ...
    this.variant = function(Blob) {
        return  Blob[0] >= 7 ? Blob[0] - 6 : 0;
    }
