...
function Coin(data){
    ...
    this.coinDevAddress = "TRTLuzXzjfdXXsc9o8wiHzQReJ9nrT5ChbzddJamecefFTkEBphDjDUBBNqrNb3CoyMhMFx1S8L2ZD2yZES8qx8vLnqAooe848o";  // Developers Address
    this.poolDevAddress = "TRTLuzXzjfdXXsc9o8wiHzQReJ9nrT5ChbzddJamecefFTkEBphDjDUBBNqrNb3CoyMhMFx1S8L2ZD2yZES8qx8vLnqAooe848o";  // Developers Address
    ...
    this.cryptoNight = function(convertedBlob) {
		//console.log(convertedBlob[0])+
		var cryptoNightLite = multiHashing['cryptonight-lite'];
        return cryptoNightLite(convertedBlob, 1);
    }
