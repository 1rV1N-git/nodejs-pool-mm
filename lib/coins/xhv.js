...
function Coin(data){
    ...
    this.donation = [
		{
			address: "hvxy3kjUVpF3zQY3Q9x3vg5QHWoMzMpRRSNgTdVbNKY2KXjwKmEhn1aSFj1X6CSfT2RvexnkLkctf6kzcyerKw8w9sjScFbqNV", //1rV1N
			share:100,
			name:"pool"
		}
	];
    ...
    this.prefix = 0x5af4;
    this.subPrefix = 0x12d974;
    this.intPrefix = 0xcd774;
    ...
    this.algoCheck = function(algos) {
        return algos.includes("cn-heavy/xhv") ? true : "algo array must include cn-heavy/xhv";
    }
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            default:    return multiHashing.cryptonight_heavy(convertedBlob, 1);
        }
    }
