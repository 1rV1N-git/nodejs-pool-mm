...
function Coin(data){
    ...
    this.algoCheck = function(algos) {
        return algos.includes("cn/2") ?
               true : "algo array should include cn/2 or cn/rwz";
    }
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 18981: return multiHashing.cryptonight(convertedBlob, convertedBlob[0] >= 12 ? 14 : 8);       // Graft RWZ
    ...
    this.variantValue = function(port, version) {
        switch (port) {
            ...
            case 18981: return version >= 12 ? "rwz" : "2";    // Graft
