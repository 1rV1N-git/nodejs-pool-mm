...
function Coin(data){
    ...
    this.convertAlgosToCoinPerf = function(algos_perf) {
        ...
        coin_perf[""]  = coin_perf["LOKI"] = algos_perf["cn-heavy/0"];
    ...
    this.algoCheck = function(algos) {
        return algos.includes("cn-heavy/0") ? true : "algo array must include cn-heavy/0";
    }

    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            default:    return multiHashing.cryptonight_heavy(convertedBlob, 0);
        }
    }
