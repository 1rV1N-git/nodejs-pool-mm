...
function Coin(data){
    ...
    this.algoCheck = function(algos) {
        return algos.includes("cn/xtl") || algos.includes("cn/xtlv9") ? true : "algo array must include cn/xtl or cn/xtlv9";
    }
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 20189: return multiHashing.cryptonight(convertedBlob, convertedBlob[0] > 4 ? 8 : 3);       // Stellite
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 20189: return version > 4 ? "cn/xtlv9" : "cn/xtl";        // Stellite
    ...
    this.variantValue = function(port, version) {
        switch (port) {
            ...
            case 20189: return version > 4 ? "xtlv9" : "xtl"; // Stellite
