                    ...
                    if (shares.hasOwnProperty(key)){
                        ...
                        shares[key].forEach(function(final_share){  // jshint ignore:line
                            ...
                            if (final_share.foundBlock) {
                                ...
                                let msgtextDiscord = "Block " + final_share.blockHeight + " **" + global.config.general.coinCode + "** was mined by " + final_share.paymentAddress.substr(-6) + msgPaymentID + " worker: " + final_share.identifier;
