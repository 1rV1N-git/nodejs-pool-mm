...
function Database(){
                    ...
                    if (shares.hasOwnProperty(key)){
                        ...
                        shares[key].forEach(function(final_share){  // jshint ignore:line
                            ...
                            if (final_share.foundBlock) {
                                ...
                                let msgtextDiscord = "Block **" + global.config.general.coinCode + "** on height ``" + final_share.blockHeight + "`` was mined by " + final_share.paymentAddress.substr(-6) + msgPaymentID + " worker: " + final_share.identifier;
    ...
    this.addWhoFound = function (blockId, paymentAddress, paymentId, worker){
        ...
        if (txn.getBinary(global.database.blockDB, blockId) == null) {
                    ...
                    setTimeout(function () { global.database.addWhoFound(blockId, paymentAddress, paymentId) }, 10*1000);
                    return;
        }
